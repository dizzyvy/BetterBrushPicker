...
-- Author: Dizzy
--
-- v0.2.7 replaces the old fixed-slot probing scan with direct enumeration of the tiles exposed by IsoWorld:getAllTiles. Persistent per-definition-list caching is kept.
...
local function install()
    ...
    print("[BetterBrushPicker] Installed v0.2.7 successfully.")
    return true
end
