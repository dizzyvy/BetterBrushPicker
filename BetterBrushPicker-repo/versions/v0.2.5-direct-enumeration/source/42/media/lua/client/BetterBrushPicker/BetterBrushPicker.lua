...
-- Author: Dizzy
--
-- v0.2.5 replaces the old fixed-slot probing scan with direct enumeration of the tiles exposed by IsoWorld:getAllTiles. Persistent per-tileset caching is kept.
...
local function loadExistingCacheSets(tilesetQueue)
    ...
    BetterBrushPicker.indexState = {
        ...
        totalActualTiles = 0,
        missingTilesets = 0,
        failedDefinitions = failedSets or 0,
    }
...
local function install()
    ...
    print("[BetterBrushPicker] Installed v0.2.5 successfully.")
    return true
end
