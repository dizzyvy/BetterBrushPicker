...
- Cache files use the BBP_CACHE_5 header because the index source changed from fixed-slot probing to direct enumeration.
...
- Cache format bumped to BBP_CACHE_5 so older fixed-slot caches are not trusted as complete.
