...
-- Author: Dizzy
--
-- v0.2.3 restores the searchable-text helper and keeps burst-based full indexing with persistent per-tileset cache. The picker no longer requires the
...
local function install()
    ...
    print("[BetterBrushPicker] Installed v0.2.3 successfully.")
    return true
end
