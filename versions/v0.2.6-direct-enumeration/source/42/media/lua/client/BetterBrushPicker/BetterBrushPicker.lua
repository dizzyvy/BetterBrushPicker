...
-- Author: Dizzy
--
-- v0.2.6 replaces the old fixed-slot probing scan with direct enumeration of the tiles exposed by IsoWorld:getAllTiles. Persistent per-tileset caching is kept.
...
local function install()
    ...
    print("[BetterBrushPicker] Installed v0.2.6 successfully.")
    return true
end
